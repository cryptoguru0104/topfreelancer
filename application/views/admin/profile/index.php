        ...
        <div class="box-body my-form-body">
            <?php echo form_open(base_url('admin/profile'), 'class="form-horizontal"' )?> 
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="username" value="<?= $admin['username']; ?>" class="form-control" id="username" placeholder="" <?php if($admin['username']) { echo 'disabled'; } ?>>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="file" name="profile_pic" value="<?= $admin['profile_pic']; ?>" class="form-control" id="profile_pic" placeholder="">
                </div>
              </div>
