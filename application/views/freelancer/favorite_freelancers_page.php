...
<!-- Start post Area -->
<section class="post-area section-gap mt-5 mb-5">
	<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-2 col-sm-12 col-12 pb-2">
								<div class="container">
									...
									<?php if(!($freelancer["id"] == $this->session->userdata('user_id'))):  ?>
										<a id="favoriteFreelancer" class="float-right favorite_freelancer" data-freelancer_id="<?= $freelancer['id']; ?>" title="<?= $freelancer["firstname"]; ?> <?= $freelancer["lastname"]; ?>">
			...
			$.ajax({
				...
				success: function (response) {
					...
					if($.trim(response) == "saved"){
						...
						$("#favoriteFreelancer img").attr("src", "<?= base_url('assets/icons/star-filled.png') ?>");
