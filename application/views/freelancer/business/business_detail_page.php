        ...
        <div class="justify-content-between d-flex flex-row">
          <div class="emp_details">
            <div class="title d-flex flex-row justify-content-between mt-2">
              <div class="titles">
                <a href=""><h2 class="mb-2"><?= $business_info['business_name']; ?></h2></a>       
              </div>
            </div>
            <div class="job-listing-footer">
              <ul class="mb-3">
                <li><i class="lnr lnr-apartment"></i> <?= get_category_name($business_info['category']); ?></li>
                <li><i class="lnr lnr-map-marker"></i> <?= get_city_name($business_info['city']); ?>, <?= get_country_name($business_info['country']); ?></li>
                <li><i class="lnr lnr-map-marker"></i> <?= $business_info['address']; ?></li>
              </ul>
              <!--<ul>
          ...
          <div class="emp_logo">
            <img src="<?= base_url().$business_info['business_logo']?>" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
