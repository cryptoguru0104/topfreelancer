  ...
  <div class="container">
    <div class="row justify-content-center d-flex">
      ...
      <div class="col-lg-12 post-list">
        ...
        <div class="topfreelancer-job-alerts">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    ?>
                    <a href="<?= base_url('employers/job/delete/'.$job['id']); ?>" class="topfreelancer-savedjobs-links btn-delete"><i title="<?=trans('delete')?>" class="lnr lnr-trash"></i></a>
                    <a href="<?= base_url('employers/job/edit/'.$job['id']); ?>" class="topfreelancer-savedjobs-links"><i title="<?=trans('edit')?>" class="lnr lnr-pencil"></i></a>
                    <a href="<?= base_url('employers/job/edit/'.$job['id']); ?>" class="topfreelancer-savedjobs-links"><i title="<?=trans('view')?>" class="lnr lnr-eye"></i></a>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
