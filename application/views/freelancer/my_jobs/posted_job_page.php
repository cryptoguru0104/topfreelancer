	...
	<div class="container">
		<div class="row justify-content-center d-flex">
			<div class="col-lg-12 post-list">
				...
				<?php if(empty($jobs)): ?>
				<p class="text-gray"><strong><?=trans('sorry')?>,</strong> <?=trans('no_job_posted')?></p>
				<?php endif; ?>

				<?php foreach($jobs as $job): ?>

				<?php
							$appDate = $job["created_date"];
							$appliedDate = date("d M Y", strtotime($appDate));
					?>
				<h4 class="text-muted text-center mb-2"><?=trans('posted_on')?> <?= $appliedDate; ?></h4>
				<div class="list_banner bg-white border col-lg-12 float-left">
					...
					<div id="block-first" class="mb-3" style="min-height:auto">
						...
						<div class="col-md-5 vac-list border-right mb-3"
							>
						...
						<div class="col-md-3 vac-list border-right fldesk" style="min-height:300px !important;overflow:auto">
							...
							<div><?= trans('hotel'); ?>:
								...
								<?php endif; ?></div>
							<div><?= trans('project_phase'); ?>:
								<?php if ($job["project_phase"] == "1"): echo trans('project_awarded');?>
								<?php elseif ($job["project_phase"] == "2"): echo trans('proposal_preparation'); ?>
								<?php else: echo trans('project_inProgress'); ?>
								<?php endif; ?>
							</div>
							<div class="row">
								<div class="col-lg-6 col-md-12 col-sm-12 mb-2 w-auto">
									<?php if($job["trainer"]) : ?>
									<div class="btn bg-warning text-black btn-custom-style2 mt-1"><?=trans('trainer')?> </div>
									<?php endif; ?>
								</div>

								<div class="col-lg-6 col-md-12 col-sm-12 w-auto ">
									<?php if($job["consultant"]) : ?>
									<div class="btn bg-info text-black btn-custom-style2 mt-1"><?=trans('consultant')?> </div>
									<?php endif; ?>
								</div>
						...
						?>
						<div class="col-md-2 vac-list" style="min-height:300px !important;overflow:auto">
							...
							<div class="flinfo text-danger" style="overflow:auto"><u><?= $job["email"]; ?></u></div>
