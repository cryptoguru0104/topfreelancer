      ...
      <div class="row">
        ...
        <?php foreach($applicants as $applicant): ?>
         <div class="col-md-6 col-sm-12 mb-20">
          <div class="topfreelancer-employer-resumes-wrap">
            <figure class="pp">
              <figcaption>
                <h2 class="title"><a href="#"><?= $applicant['firstname']; ?> <?= $applicant['lastname']; ?></a> <a href="<?= base_url($applicant['resume']); ?>" class="topfreelancer-resumes-download"><i class="lnr lnr-download"></i> <?=trans('download_cv')?></a></h2>
                <span class="topfreelancer-resumes-subtitle"><?= $applicant['job_title']; ?></span>
                <ul>
                  <li>
            ...
            <ul class="topfreelancer-resumes-options">
